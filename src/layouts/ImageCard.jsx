    ...
    return (
        <section className="flex justify-center items-center gap-4 my-20 text-[#fff]">
            <div className="w-[350px] h-[350px] bg-[#ffbe0b] flex flex-col justify-center items-center p-5">
                <h2 className="mb-[35px] tracking-widest text-[13px] font-bold text-black">DUNDER MİFFLİN</h2>
            ...
            <div className="w-[350px] h-[350px] bg-[#ff006e] flex flex-col justify-center items-center p-5">
                <h2 className="mb-[35px] tracking-widest text-[13px] font-bold text-black">GELECEĞİMİZİ KORUYALIM</h2>
            ...
            <div className="w-[350px] h-[350px] bg-[#7856ff] flex flex-col justify-center items-center p-5">
                <h2 className="mb-[35px] tracking-widest text-[13px] font-bold text-black">TÜM ALIŞVERİŞLERDE</h2>
